...
Temp.  D6
*/
#define BLYNK_TEMPLATE_ID "TMPL6v-i9tdVg"
...
char auth[] = "U_KkKy7JPbaG-xtPAhGb1VNYKYpxwqDg";
char ssid[] = "Brother ";
char pass[] = "Speed@12345";

DHT dht(D6, DHT11);//(DHT sensor pin,sensor type)  D6 DHT11 Temperature Sensor
BlynkTimer timer;
